...
_PTR _EXFUN(bsearch,
            (const _PTR _key, const _PTR _base, size_t _nmemb, size_t _size,
...
_VOID _EXFUN(qsort, (_PTR _base, size_t _nmemb, size_t _size,
...
unsigned long _EXFUN(_strtoul_r, (struct _reent *, const char *_n_PTR,
                                  char **_end_PTR, int _base));
