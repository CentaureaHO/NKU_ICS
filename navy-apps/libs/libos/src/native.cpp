...
#define _KEYS(_)                                                                                                       \
    ...
    _(E)                                                                                                               \
    _(R)                                                                                                               \
    _(T) _(Y) _(U) _(I) _(O) _(P) _(LEFTBRACKET) _(RIGHTBRACKET) _(BACKSLASH) _(CAPSLOCK) _(A) _(S) _(D) _(F) _(G)     \
        _(H) _(J) _(K) _(L) _(SEMICOLON) _(APOSTROPHE) _(RETURN) _(LSHIFT) _(Z) _(X) _(C) _(V) _(B) _(N) _(M) _(COMMA) \
