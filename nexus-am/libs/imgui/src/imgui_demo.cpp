...
// value
#if (__GNUC__ >= 6)
#pragma GCC diagnostic ignored "-Wmisleading-indentation" // warning: this 'if'
// clause does not
// guard this
...
struct ExampleAppConsole {
  ...
  void ExecCommand(const char *command_line) {
    ...
    if (Stricmp(command_line, "CLEAR") == 0) {
      ...
      for (unsigned int i = History.Size >= 10 ? History.Size - 10 : 0;
           i < (unsigned int)History.Size; i++)
        AddLog("%3d: %s\n", i, History[i]);
    } else {
