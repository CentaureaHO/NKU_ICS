...
static ee_u16 list_known_crc[] = {(ee_u16)0xe714,
                                    (ee_u16)0xe3c1};
static ee_u16 matrix_known_crc[] = {(ee_u16)0x1fd7,
                                      (ee_u16)0x0747};
static ee_u16 state_known_crc[] = {(ee_u16)0x8e3a,
                                     (ee_u16)0x8d84};
*/
void *iterate(void *pres) {
  ee_u32 i;
...
<<<<<<< HEAD
    ...
    if (results[0].iterations == 0) {
        ...
        if (divisor == 0) /* some machines cast float to int as 0 since this conversion is not
