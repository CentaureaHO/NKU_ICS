...
make_group(gp1, EX(add), EX(or), EX(adc), EX(sbb), EX(and), EX(sub), EX (xor), EX(cmp))
    ...
    make_group(gp2, EX(rol), EX(ror), EMPTY, EMPTY, EX(shl), EX(shr), EMPTY, EX(sar))
    ...
    /* 0xff */
    make_group(gp5, EX(inc), EX(dec), IDEX(gp5_J, call), IDEX(gp5_J, call), IDEX(gp5_J, jmp), IDEX(gp5_J, jmp),
        EX(push), EMPTY)
    ...
    opcode_entry opcode_table[512] = {
        /* 0x00 */ IDEXW(G2E, add, 1),
        IDEX(G2E, add),
        IDEXW(E2G, add, 1),
        IDEX(E2G, add),
        /* 0x04 */ IDEXW(I2a, add, 1),
        IDEX(I2a, add),
        EMPTY,
        EMPTY,
        /* 0x08 */ IDEXW(G2E, or, 1),
        ...
        IDEXW(E2G, sub, 1),
        IDEX(E2G, sub),
        /* 0x2c */ IDEXW(I2a, sub, 1),
        IDEX(I2a, sub),
        EMPTY,
        EMPTY,
        /* 0x30 */ IDEXW(G2E, xor, 1),
        IDEX(G2E, xor),
        IDEXW(E2G, xor, 1),
        IDEX(E2G, xor),
        /* 0x34 */ IDEXW(I2a, xor, 1),
        IDEX(I2a, xor),
        EMPTY,
        EMPTY,
        /* 0x38 */ IDEXW(G2E, cmp, 1),
        IDEX(G2E, cmp),
        IDEXW(E2G, cmp, 1),
        IDEX(E2G, cmp),
        /* 0x3c */ IDEXW(I2a, cmp, 1),
        IDEX(I2a, cmp),
        EMPTY,
        EMPTY,
        /* 0x40 */ IDEX(r, inc),
        ...
        EMPTY,
        EMPTY,
        /* 0x20 */ IDEX(mov_Cd2r, mov_cr2r),
        EMPTY, 
        IDEX(mov_r2Cd, mov_r2cr),
        EMPTY,
        /* 0x24 */ EMPTY,
        EMPTY,
        EMPTY,
        ...
        IDEXW(E, setcc, 1),
        IDEXW(E, setcc, 1),
        /* 0x98 */ IDEXW(E, setcc, 1),
        IDEXW(E, setcc, 1),
        IDEXW(E, setcc, 1),
        IDEXW(E, setcc, 1),
        /* 0x9c */ IDEXW(E, setcc, 1),
        IDEXW(E, setcc, 1),
        IDEXW(E, setcc, 1),
        IDEXW(E, setcc, 1),
        /* 0xa0 */ EMPTY,
