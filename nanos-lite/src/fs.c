...
ssize_t fs_read(int fd, void* buf, size_t len)
{
    ...
    switch (fd)
    {
        ...
        case FD_FB: panic("Not implemented for read FD_FB");
        case FD_EVENTS: read_len = events_read(buf, len); return read_len;
        case FD_DISPINFO:
...
ssize_t fs_write(int fd, const void* buf, size_t len)
{
    ...
    switch (fd)
    {
        ...
        case FD_FB:
            ...
            file_table[fd].open_offset += len;
            return len;
        case FD_EVENTS: panic("Not implemented for read FD_EVENTS");
        case FD_DISPINFO: panic("Not implemented for read FD_DISPINFO");
        case FD_NORMAL: panic("Not implemented for read FD_NORMAL");
        default: break;
    }
...
off_t fs_lseek(int fd, off_t offset, int whence)
{
    ...
    switch (whence)
    {
        ...
        default: panic("Unsupported whence: %d", whence);
    }
